...
For popup-specific experiment matrices covering placement, triggers, messaging, personalization, and frequency rules, see [references/experiments.md](references/experiments.md).
